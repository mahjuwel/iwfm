<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Branch Manager Datewise Credit
        <small>Details</small>
      </h1>
      <ol class="breadcrumb">
     ...
     <section class="invoice">
      ...
      <div class="row invoice-info">
        <div class="col-sm-4 invoice-col">
          <address>
            <strong>Branch Manager: <?php echo $cps[0]->manger; ?>(<?php echo $cps[0]->user_id; ?>)</strong><br>
            Branch: <?php echo $cps[0]->branch; ?><br> 
        ...
        <div class="col-sm-4 invoice-col">
          <address>
         <p style="text-align: center;"> Date: <?php echo $dt=$this->session->userdata('rdate1');
   ?>--<?php echo  $dt2=$this->session->userdata('rdate2'); ?></p>
          </address> 
        ...
        <div class="col-xs-12 table-responsive">
          <table class="table table-striped">
            ...
            <?php }} ?>
             ...
             <tr>
              <th></th>
              <th><?php echo $cps[0]->weight; ?></th>
             <th><?php echo $cps[0]->makingcharge; ?></th>
              <th></th> 
              <th></th>
              <th></th>
              <th></th>
