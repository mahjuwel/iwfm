            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <?php if (isset($cus)) { ?>
        <?php foreach ($cus as $si) { ?>
                <tr>
                  <td><a href="<?php echo base_url(); ?>index.php/SalePanel/CustomerPurchase?mob=<?php echo $si->mobile; ?>"><?php echo $si->mobile; ?></a></td> 
             ...
             $previllage=$_SESSION['type'];      
               ...
               if($previllage<1){?>
 <a class="btn btn-sm btn-primary" href="javascript:void(0)" title="EDIT" onclick="edit_customer('<?php echo $si->mobile; ?>')"><i class="fa fa-money"></i></a> 
  <?php }else{ ?>
            <span>NotPermit</span>
      <?php } ?>
</td>
