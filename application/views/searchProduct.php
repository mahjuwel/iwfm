    ...
    <section class="content">
      ...
      <br>
           ...
           <div class="tab-pane active" id="settings">
                <form class="form-horizontal" method="GET" action="<?php echo base_url(); ?>index.php/Inventory/StoreProductSearch">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control select2" name="category" style="width: 45%;" required="">
