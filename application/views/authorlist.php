        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-body table-responsive">
                <span style="float: right"><a href="<?php echo base_url();?>index.php/Admin/DownloadCSV">Download</a>||<a href="<?php echo base_url();?>index.php/Admin/CO_AUTHORDownloadCSV">Download(CO-AUTHOR-1stAbstract)</a>||<a href="<?php echo base_url();?>index.php/Admin/CO_AUTHORDownloadCSV2">Download(CO-AUTHOR-2ndAbstract)</a></span>
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                <tr>
                  <th>#</th>
                  <th>Paper Submission<br> Author</th>
                  <th>Email</th>
                  <th>Role</th>
                  <th>Address</th>
