...
<div class="wrapper">
  ...
  <header class="main-header" style="background-color: #050505">
    ...
    <!-- Logo -->
    <a href="<?php echo base_url() ?>index.php/SalePanel/Sales" class="logo">
            ...
            <?php if($this->session->userdata('user_id')==''){
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="<?php echo base_url() ?>index.php/Admin/admin_logout" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
