...
class Main extends CI_Controller {
	...
	public function request_api_hosted()
	{
		if($this->input->get_post('placeorder'))
		{
			...
			$post_data['cus_add2'] = $this->input->post('cus_add2');
            ...
            # OPTIONAL PARAMETERS
			$post_data['value_a'] = $this->input->post('value_a');
			$post_data['value_b'] = $this->input->post('value_b');
			$post_data['value_c'] = $this->input->post('value_c');
			$post_data['value_d'] = $this->input->post('value_d');
...
// 			{
        ...
        $data3=array();
        $data3['tran_id']=$this->session->userdata('tran_id');
        $data3['total_amount']=$this->session->userdata('total_amount');
        $data3['currency']=$this->session->userdata('currency');
//         $data4=$this->UserModel->MemberInfoData();
//       $ta=$this->session->userdata('total_amount');
//       $tr=$this->session->userdata('tran_id');
...
// <p>Abstract id: $data4->prof_id | $data4->prof_id2</p>
// <p>Author/Paricipant Name: $data4->membername</p>
// <p>Type: Non-Student</p>
// <p>Nationality: $data4->countryname</p>
// <p style='font-weight:bold'>Payments information:</p>
// <p>Amount Paid: $ta</p>
// <p>Payment Status: Success </p>
// <p>Transaction id: $tr</p>

// </body>
// </html>";     
//   $email=$this->session->userdata('email');
//   $result=$this->MailModel->mail_send4($email,$subject,$message);
 $result=$this->UserModel->memberTranDataupdated($data3);
  if($result){
